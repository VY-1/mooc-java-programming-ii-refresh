...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        vehicleRegistry.add(li3, "Jürgen");
        vehicleRegistry.add(li1, "Arto");
        
        System.out.println("The owner is: " + vehicleRegistry.get(li1));
        System.out.println("The owner is: " + vehicleRegistry.get(li3));
